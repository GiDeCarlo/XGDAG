...
def get_dataset_from_graph(path_to_graph, disease_id, verbose=True, quartile=True, from_diamond=False):
		...
		path = PATH_TO_DATASETS if not from_diamond else PATH_TO_DATASETS + 'Diamond_dataset/'
